...
<head>
    <head>
        ...
        <title>PasswordManager - Login</title>
                        ...
                        <div class="col-lg-6">
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-4">Login to PasswordManager!</h1>
                                </div>
                                <form class="user" method="post" action="/authentication/login">
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user"
                                                   id="accountID" name="accountID" aria-describedby="emailHelp"
